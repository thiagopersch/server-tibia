...
enum MagicEffect_t {
    MAGIC_EFFECT_DRAW_BLOOD    = 0x00,//00
    MAGIC_EFFECT_LOSE_ENERGY    = 0x01,//01
    MAGIC_EFFECT_POFF        = 0x02,//02
    MAGIC_EFFECT_BLOCKHIT        = 0x03,//03
    MAGIC_EFFECT_EXPLOSION_AREA    = 0x04,//04
    MAGIC_EFFECT_EXPLOSION_DAMAGE    = 0x05,//05
    MAGIC_EFFECT_FIRE_AREA        = 0x06,//06
    MAGIC_EFFECT_YELLOW_RINGS    = 0x07,//07
    MAGIC_EFFECT_POISON_RINGS    = 0x08,//08
    MAGIC_EFFECT_HIT_AREA        = 0x09,//09
